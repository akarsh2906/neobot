...
def generate_launch_description():
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=join(neobot_path, 'maps', 'neobot_map.yaml'), description='Full path to map yaml file to load'
    )
    ...
    bringup_cmd_group = GroupAction(
        [
            ...
            Node(
                ...
                parameters=[{
                    'use_sim_time': False,  # Set True if you're using simulated time
